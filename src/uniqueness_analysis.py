...
"""Computing seed uniqueness and e-hits for simulated and biological sequences

E-size is a measure of how repetitive the seeds in a query sequence are,
on average, in a reference dataset; details on calculation are given in Sahlin, 2022 
"""
