...
def seq_to_altstrobes_iter(seq: str, k_size1: int, k_size2: int, strobe_w_min_offset: int,
    ...
    ############################################################################
    # Kristoffer note: Commented lines below for controlled entropy calc
    ...
    # strobe_w_max_offset2 = int(strobe_w_max_offset) # Kristoffer note only for controlled entropy calc
    # strobe_w_min_offset2 = int(strobe_w_min_offset) # Kristoffer note only for controlled entropy calc
    ############################################################################
    ...
    for index_position, (p1, hash_m1) in enumerate(hash_seq_list_thinned1):  # [:-k_size]:
        ...
        if hash_m1 % 2 == 0: # first k_1, then k_2 (e.g. 10-20)
            # print("10-20")
        ...
        else: # first k_2, then k_1 (e.g. 20-10)
            # print("20-10")
            #print("ERROR")
...
def altstrobes(seq: str, k_size1: int, k_size2: int, strobe_w_min_offset: int,
    ...
    altstrobes = {tuple(index): h for index, h, min_values in seq_to_altstrobes_iter(
        seq, k_size1, k_size2, strobe_w_min_offset, strobe_w_max_offset, prime, w, order
    )}
    return altstrobes
...
def randstrobes(seq: str, k_size: int, strobe_w_min_offset: int,
    ...
    if return_min_value:
        ...
        for index, h, min_values in seq_to_randstrobes_iter(seq, m_size, strobe_w_min_offset, strobe_w_max_offset, prime, w, order):
            randstrobes[tuple(index)] = h
            randstrobes_min_values[h] = min_values
        return randstrobes, randstrobes_min_values

    else:
        randstrobes = {tuple(index): h for index, h, min_values in seq_to_randstrobes_iter(
